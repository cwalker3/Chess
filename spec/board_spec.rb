...
describe Board do
  ...
  describe 'checkmate' do
    ...
    context 'when white is in checkmate' do
      let(:board) { Board.from_fen(Fen.new('8/8/8/8/8/2p5/1q6/K7 w - - 0 1')) }
      it 'returns true' do
    ...
    context 'when black is not in checkmate' do
      let(:board) { Board.from_fen(Fen.new('7k/6Q1/8/8/8/8/8/2K5 w - - 0 1')) }
      it 'returns false' do
    ...
    context 'when black is in checkmate' do
      let(:board) { Board.from_fen(Fen.new('7k/8/8/8/7R/8/8/2K3R1 w - - 0 1')) }
      it 'returns true' do
  ...
  describe 'check' do
    ...
    context 'when white is not in check' do
      let(:board) { Board.from_fen(Fen.new) }
      it 'returns true' do
    ...
    context 'when black is in check' do
      let(:board) { Board.from_fen(Fen.new('3R3B/B7/2N1N3/1N3N2/R2k3R/1N3N2/2N1N3/B2R2B1 w - - 0 1')) }
      it 'returns true' do
    ...
    context 'when black is not in check' do
      let(:board) { Board.from_fen(Fen.new('k7/1b6/8/3Q4/8/8/8/K7 w - - 0 1')) }
      it 'returns true' do
  ...
  describe 'stalemate' do
    ...
    context 'when white is in stalemate' do
      let(:board) { Board.from_fen(Fen.new('3k4/8/8/8/8/2p5/1r6/K7 w - - 0 1')) }
      it 'returns true' do
    ...
    context 'when black is not in stalemate' do
      let(:board) { Board.from_fen(Fen.new('3k4/2R1B3/8/8/8/8/8/K7 w - - 0 1')) }
      it 'returns false' do
    ...
    context 'when black is in stalemate' do
      let(:board) { Board.from_fen(Fen.new('3k4/2R1R3/8/8/8/8/8/K7 w - - 0 1')) }
      it 'returns true' do
  ...
  describe 'insufficient_material?' do
    context 'when there is a King vs King' do
      let(:board) { Board.from_fen(Fen.new('3k4/8/8/8/8/8/8/2K5 w - - 0 1')) }
      it 'returns true' do
    ...
    context 'when there is a King vs King and Bishop' do
      let(:board) { Board.from_fen(Fen.new('3k4/4b3/8/8/8/8/8/2K5 w - - 0 1')) }
      it 'returns true' do
        expect(board.insufficient_material?).to eq(true)
      end
    end
    ...
    context 'when there is a King vs King and Knight' do
      let(:board) { Board.from_fen(Fen.new('3k4/8/8/8/8/8/3N4/2K5 w - - 0 1')) }
      it 'returns true' do
        expect(board.insufficient_material?).to eq(true)
      end
    end
    ...
    context 'when there is a King and Bishop vs King and Bishop (same square color bishops)' do
      let(:board) { Board.from_fen(Fen.new('3k4/4b3/8/8/8/8/3B4/2K5 w - - 0 1')) }
      it 'returns true' do
        expect(board.insufficient_material?).to eq(true)
      end
    end
    ...
    context 'when there is a King and Bishop vs King and Bishop (different square color bishops)' do
      let(:board) { Board.from_fen(Fen.new('3k4/5b2/8/8/8/8/3B4/2K5 w - - 0 1')) }
      it 'returns false' do
  ...
  describe 'valid_move?' do
    ...
    context 'when a piece is pinned to the king' do
      let(:board) { Board.from_fen(Fen.new('3rk3/8/8/8/3Q4/8/8/3K4 w - - 0 1')) }
      it 'cannot move' do
    ...
    context 'when the king tries to place itself in check' do
      let(:board) { Board.from_fen(Fen.new('1k6/8/8/8/3q4/8/8/4K3 w - - 0 1')) }
      it 'returns false' do
  ...
  describe 'enemy?' do
    context do
      let(:enemy_board) { Board.from_fen(Fen.new('8/8/8/3ppp2/4P3/8/8/8 w - - 0 1'))}
