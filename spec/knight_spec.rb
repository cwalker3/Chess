...
RSpec.describe Knight do
  ...
  describe 'moves' do
    context 'when knight has 8 moves' do
      let(:board) { FenReader.new('8/8/8/8/3N4/8/8/8 w - - 0 1').board }
    ...
    context do
      let(:board) { FenReader.new('8/8/8/2ppp3/2pNp3/2ppp3/8/8 w - - 0 1').board }
    ...
    context do
      let(:board) { FenReader.new('8/8/2p1p3/1p3p2/3N4/1p3p2/2p1p3/8 w - - 0 1').board }
